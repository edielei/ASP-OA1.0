...
<script>
$(function(){
	$('#zwid').load('jQ-zw.asp',function(){$('#zwid').val('<%=r(3)%>');});
	$('#xb').val('<%=r(6)%>');
	$('#mz').val('<%=r(8)%>');
	$('#xl').val('<%=r(13)%>');
	$('#zzmm').powerFloat({
	...
	s.click(function(){
		...
		var grzp=$('#grzp').contents().find('span');if(grzp.length==0){grzp="<%=r(19)%>"}else{grzp=encodeURIComponent(grzp.html())}
		$.post('EditC.asp','id=<%=id%>&gh='+gh+'&rzsj='+rzsj+'&zwid='+zwid+'&fj='+fj+'&zname='+zname+'&ozname='+ozname+'&xb='+xb+'&csrq='+csrq+'&mz='+mz+'&jg='+jg+'&zzmm='+zzmm+'&rtsj='+rtsj+'&hf='+hf+'&xl='+xl+'&xw='+xw+'&xz='+xz+'&sfzhm='+sfzhm+'&jk='+jk+'&grzp='+grzp+'&add='+add+'&jtdh='+jtdh+'&shouji='+shouji+'&xxjl='+xxjl+'&gzjy='+gzjy+'&hjqk='+hjqk+'&zycy='+zycy+'&jjlxr='+jjlxr+'&lxdh='+lxdh,function(a){
			switch(a){
...
<table border="0" cellpadding="0" cellspacing="0" class="table">
	<tr><th class="th" colspan="6">&nbsp;编辑员工</th></tr>
    <tr>
    	<td width="65" align="right" nowrap="nowrap" class="td">工号:</td><td class="td"><input id="gh" class="input" style="width:68px;" value="<%Easp.WH r(0)%>" /> <em title="必填项">*</em></td>
<td align="right" nowrap="nowrap" class="td">入职时间:</td><td class="td"><input id="rzsj" class="input" style="width:68px;" onfocus="WdatePicker({doubleCalendar:true,minDate:'{%y-20}-%M-%d',maxDate:'%y-{%M+1}-%d'})" value="<%=Easp.DateTime(r(2),"yyyy-mm-dd")%>" /> <em title="必填项">*</em></td>
<td align="right" nowrap="nowrap" class="td">职位:</td><td class="td"><select class="input" id="zwid"><option value="">请选择</option></select> <em title="必填项">*</em></td>
   ...
   <tr>
   	...
   	<td class="td"><input id="zname" class="input" style="width:60px;" value="<%Easp.WH r(4)%>" /> <em title="必填项">*</em></td>
   	<td align="right" nowrap="nowrap" class="td">曾用名:</td>
   	<td class="td"><input id="ozname" class="input" style="width:60px;" value="<%Easp.WH r(5)%>" /></td>
   ...
   <tr>
     ...
     <td class="td"><input id="csrq" class="input" style="width:68px;" onfocus="WdatePicker({doubleCalendar:true,maxDate:'{%y-16}-%M-%d'})" value="<%=Easp.DateTime(r(7),"yyyy-mm-dd")%>" /></td>
     ...
     <td class="td"><input id="jg" class="input" style="width:110px;" value="<%Easp.WH r(9)%>" /></td>
  </tr>
   <tr>
   	<td width="65" align="right" nowrap="nowrap" class="td">政治面貌:</td><td class="td"><input id="zzmm" class="input" style="width:60px;" readonly="readonly" value="<%=r(10)%>" /></td>
   	<td align="right" nowrap="nowrap" class="td">入党/团时间:</td>
   	<td class="td"><input id="rtsj" class="input" style="width:68px;" onfocus="WdatePicker({doubleCalendar:true})" value="<%=Easp.DateTime(r(11),"yyyy-mm-dd")%>" /></td>
   	<td align="right" nowrap="nowrap" class="td">婚否:</td><td class="td"><input id="hf" class="input" style="width:50px;" value="<%Easp.WH r(12)%>" /></td>
  </tr>
   <tr>
   	...
   	<td align="right" nowrap="nowrap" class="td">学位:</td><td class="td"><input id="xw" class="input" style="width:60px;" value="<%Easp.WH r(14)%>" /></td>
   	<td align="right" nowrap="nowrap" class="td">学制:</td><td class="td"><input id="xz" class="input" style="width:50px;" value="<%Easp.WH r(15)%>" /></td>
  </tr>
   <tr>
     <td width="65" align="right" nowrap="nowrap" class="td">身份证号码:</td>
     <td class="td"><input id="sfzhm" class="input" style="width:138px;" value="<%Easp.WH r(16)%>" /></td><td align="right" class="td">分机:</td><td class="td"><input id="fj" class="input" style="width:68px;" value="<%Easp.WH r(17)%>" /></td>
     <td align="right" nowrap="nowrap" class="td">健康情况:</td>
     <td class="td"><input id="jk" class="input" style="width:50px;" value="<%Easp.WH r(18)%>" /></td>
  </tr>
   <tr>
     <td align="right" nowrap="nowrap" class="td">个人照片:</td>
     <td colspan="5" class="td">不修改请留空。<iframe id="grzp" src="../C/UpT.asp" frameborder="0" height="24" width="400" align="middle"></iframe><br /></td>
   </tr>
   <tr>
     <td width="65" align="right" nowrap="nowrap" class="td">家庭住址:</td>
     <td colspan="5" class="td"><input id="add" class="input" style="width:100%;" value="<%Easp.WH r(20)%>" /></td>
  </tr>
   <tr>
     <td width="65" align="right" nowrap="nowrap" class="td">家庭电话:</td>
     <td colspan="3" class="td"><input id="jtdh" class="input" style="width:100%;" value="<%Easp.WH r(21)%>" /></td>
     <td align="right" nowrap="nowrap" class="td">手机:</td>
     <td class="td"><input id="shouji" class="input" style="width:100%;" value="<%Easp.WH r(22)%>" /></td>
  </tr>
   <tr>
     <td width="65" align="right" nowrap="nowrap" class="td">学习经历:</td>
     <td colspan="5" class="td"><textarea id="xxjl" class="input" style="width:100%;height:50px;"><%Easp.WH r(23)%></textarea></td>
  </tr>
   <tr>
     <td width="65" align="right" nowrap="nowrap" class="td">工作经验:</td>
     <td colspan="5" class="td"><textarea class="input" id="gzjy" style="width:100%;height:50px;"><%Easp.WH r(24)%></textarea></td>
  </tr>
   <tr>
     <td width="65" align="right" nowrap="nowrap" class="td">获奖情况:</td>
     <td colspan="5" class="td"><textarea class="input" id="hjqk" style="width:100%;height:50px;"><%Easp.WH r(25)%></textarea></td>
  </tr>
   <tr>
     <td width="65" align="right" nowrap="nowrap" class="td">家庭&nbsp;&nbsp;&nbsp;&nbsp;<br />主要成员:</td>
     <td colspan="5" class="td"><textarea class="input" id="zycy" style="width:100%;height:50px;"><%Easp.WH r(26)%></textarea></td>
  </tr>
   <tr>
     <td width="65" align="right" nowrap="nowrap" class="td"> 紧急联系人:</td>
     <td colspan="3" class="td"><input id="jjlxr" class="input" style="width:100%;" value="<%Easp.WH r(27)%>" /></td>
     <td align="right" nowrap="nowrap" class="td">&nbsp;联系电话:</td>
     <td class="td"><input id="lxdh" class="input" style="width:100%;" value="<%Easp.WH r(28)%>" /></td>
  </tr>
   <tr>

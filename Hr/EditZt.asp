...
$(function(){
	...
	s.click(function(){
		...
		$.post('EditZtC.asp','id=<%=id%>&zt='+zt+'&sj='+sj,function(a){
			switch(a){
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
    	<td width="65" align="right">状态：</td><td><select id="zt" class="input"><option value="">请选择</option><option value="离职">离职</option><option value="退休">退休</option></select> <em title="必填项">*</em></td>
    </tr>
    <tr>

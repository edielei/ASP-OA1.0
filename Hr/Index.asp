...
<body>
<div id="sousuo">姓名：<input id="zname" class="input" style="width:80px;" /> <input type="submit" value="搜索" id="tj" class="btnss" /></div>
...
<th class="th" colspan="7">&nbsp;<a href="Index.asp">员工一览 - 在职</a></th>
    ...
    <%Dim rs,t,i
	Set rs=Easp.db.GPR("0:15",Array("uinfo:id,gh,zname,xb,bmid,zwid","lzsj = '0' and txsj = '0'","gh asc"))
	if Easp.IsN(rs) then

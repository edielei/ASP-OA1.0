...
id=Easp.Get("id:n")
if Easp.IsN(id) then Easp.RR "Lz.asp"
...
<tr>
<th class="th" colspan="8">&nbsp;<a href="Lz.asp">员工一览 - 离职</a>(<%Easp.WH bm%>)</th>
</tr>
    ...
    <%Dim rs,t,i
	Set rs=Easp.db.GPR("0:15",Array("uinfo:id,gh,zname,xb,bmid,zwid,lzsj","lzsj <> '0' and bmid="&id,"gh asc"))
	if Easp.IsN(rs) then

...
$(function(){
	...
	s.click(function(){
		...
		$.post('ToLzC.asp','id=<%=id%>&lzsj='+sj,function(a){
			switch(a){
...
<table border="0" cellpadding="0" cellspacing="0" class="table" style="margin:0;">
    ...
    <tr><td align="right" class="td">离职时间：</td><td class="td"><input id="sj" class="input" style="width:68px;" onfocus="WdatePicker()" /> <em title="必填项">*</em></td></tr>

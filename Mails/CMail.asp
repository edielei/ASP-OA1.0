...
<body>
<div id="sousuo"><span style="float:left;"><input type="button" value="新建" class="btn" onclick="location.href='NewCMail.asp'" /></span>标题：<input id="bt" class="input" style="width:120px;" /> <input id="tj" type="submit" value="搜索" class="btnss" /></div>
<table border="0" cellpadding="0" cellspacing="0" class="table">
    ...
    <%Dim rs,t,i
	Set rs=db.GPR("0:15",Array("CMail:id,unames,bt","fjr='"&Easp.Cookie("uinfo>uname:s")&"'","id desc"))
	if Easp.IsN(rs) then

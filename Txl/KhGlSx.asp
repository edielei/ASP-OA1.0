...
if Easp.IsN(mc) or Easp.IsN(zname) then Easp.RR "KhGl.asp"
%><!DOCTYPE html>
<html lang="cn">
<head>
...
db.C(rs)
db.SetPager "default", "总共{recordcount}条记录  每页{pagesize}条 {pageindex}/{pagecount}页 {first}{prev}{liststart}{list}{listend}{next}{last}转到 {jump} 页",Array("listlong:5","link:KhGlSx.asp?page=*&mc="&Server.URLEncode(mc)&"&zname="&Server.URLEncode(zname))

...
$(function(){
	...
	s.click(function(){
		...
		$.post('AddBscC.asp','uname='+uname+'&mc='+mc+'&dz='+dz+'&shouji='+shouji+'&zj='+zj+'&email='+email,function(a){
			switch(a){
				case 'OK':art.dialog.open.api.hide();art.dialog.through({icon:'succeed',content:'添加办事处成功',resize:false,time:3,ok:function(){window.parent["mkj"].location.reload();},close:function(){
...
<table border="0" cellpadding="0" cellspacing="0" class="table">
    ...
    <tr><td width="80" align="right" class="td">办事处名称：</td><td class="td"><input id="mc" class="input" /> <em title="必填项">*</em></td></tr>

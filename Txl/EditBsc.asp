...
Dim id,r
id=Easp.Get("id:n:0")
r=db.RT("Bsc","id="&id,"zname,mc,dz,shouji,zj,email")
...
$(function(){
	...
	s.click(function(){
		...
		var mc=$('#mc').vd('请输入办事处名称！',1);if(!mc){return}
		...
		$.post('EditBscC.asp','id=<%=id%>&uname='+uname+'&mc='+mc+'&dz='+dz+'&shouji='+shouji+'&zj='+zj+'&email='+email,function(a){
			switch(a){
				case 'OK':art.dialog.open.api.hide();art.dialog.through({icon:'succeed',content:'修改成功',resize:false,time:3,close:function(){
					window.parent["mkj"].location.href='/Txl/BscGl.asp';
				}});break;
...
<table border="0" cellpadding="0" cellspacing="0" class="table">
    ...
    <tr><td width="80" align="right" class="td">办事处名称：</td><td class="td"><input class="input" id="mc" value="<%Easp.WH r(1)%>" /> <em title="必填项">*</em></td></tr>

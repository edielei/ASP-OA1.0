...
if Easp.IsN(zname) then Easp.RR "Kh.asp"
%><!DOCTYPE html>
<html lang="cn">
<head>
...
$(function(){
	...
	s.click(function(){
		...
		location.href='KhN.asp?zname='+zname;
	});
});
</script>
</head>
...
db.C(rs)
db.SetPager "default", "总共{recordcount}条记录  每页{pagesize}条 {pageindex}/{pagecount}页 {first}{prev}{liststart}{list}{listend}{next}{last}转到 {jump} 页",Array("listlong:5","link:KhN.asp?page=*&zname="&Server.URLEncode(zname))

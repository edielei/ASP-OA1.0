...
if Easp.IsN(zname) then Easp.RR "KhGl.asp"
%><!DOCTYPE html>
<html lang="cn">
<head>
...
$(function(){
	...
	s.click(function(){
		...
		location.href="KhGlN.asp?zname="+zname;
	});
	$('#mc').change(function(){
...
<tr  style="font-weight:700;background:#E9FAEF;"><td class="td">姓名</td><td class="td">公司名称</td><td class="td">地址</td><td class="td">手机</td><td class="td">座机</td><td class="td">邮箱</td><td width="68" align="center" class="td">操作</td></tr><%Dim rs,t,i
Set rs=db.GPR("0:15",Array("kh:id,zname,mc,dz,shouji,zj,email","zname like '%"&zname&"%'","id desc"))
if Easp.IsN(rs) then
Easp.W "<tr><td class=""td"" align=""center"" colspan=""7"">找不到你要查找的记录！</td></tr></table>"
Else
t=rs.GetRows(rs.PageSize)
db.C(rs)
db.SetPager "default", "总共{recordcount}条记录  每页{pagesize}条 {pageindex}/{pagecount}页 {first}{prev}{liststart}{list}{listend}{next}{last}转到 {jump} 页",Array("listlong:5","link:KhGlN.asp?page=*&zname="&Server.URLEncode(zname))

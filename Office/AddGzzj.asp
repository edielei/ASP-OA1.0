...
$(function(){
	...
	s.click(function(){
		...
		$.post('AddGzzjC.asp','bt='+bt+'&nr='+nr+'&sj='+sj,function(a){
			switch(a){
				case 'OK':alert('发表成功！');location.replace('Gzzj.asp');break;
...
<table border="0" cellpadding="0" cellspacing="0" class="table">
	<tr>
		<th colspan="2" class="th">&nbsp;添加工作总结</th>
	</tr>
    <tr>
    	<td width="38" class="td">标题：</td>
    	<td class="td"><input id="bt" class="input" style="width:250x;" /> <em title="必填项">*</em></td>
    </tr>
    <tr>

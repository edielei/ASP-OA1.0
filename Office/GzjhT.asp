<!--#include file="../Inc/GzjhCs.asp"--><%Dim id
id=Easp.Get("id:n")
...
<body>
<div id="sousuo"><span style="float:left;"><input class="btnss" type="button" value="新建" onClick="add()" /></span>类别：<%Easp.Ext("ed").JhTypes()%>　标题：<input id="bt" class="input" style="width:120px;" /> <input id="tj" type="submit" value="搜索" class="btnss" /></div>
<table border="0" cellpadding="0" cellspacing="0" class="table">
    <tr><th class="th" colspan="6">&nbsp;<a href="Index.asp">工作计划</a></th></tr>
	...
	Dim rs,t,i
	Set rs=db.GPR("0:15",Array("V_Gzjh:id,bt,kssj,jssj,types,typesid","uname='"&Easp.Cookie("uinfo>uname:s")&"' and typesid="&id,"id desc"))
	if Easp.IsN(rs) then

<!--#include file="../Inc/Cse.asp"--><%Dim id,rsa
id=Easp.Get("id:n:0")
rsa=Easp.db.RT("Bm","id="&id,"bt")
%><!DOCTYPE html>
...
//上移下移
function UpOne(num){$.get('../C/UpOnea.asp?t=Zw&id='+num,function(){location.reload()});}
function DownOne(num){$.get('../C/DownOnea.asp?t=Zw&id='+num,function(){location.reload()});}
</script>
</head>
<body>
...
<table border="0" cellpadding="0" cellspacing="0" class="table">
	<tr>
		<th class="th" colspan="4">&nbsp;<a href="Zw.asp">职位管理</a> - <%Easp.WH rsa%></th>
	</tr><tr style="font-weight:700;background:#E9FAEF;">
<td class="td">职位名称</td>
<td class="td">所属部门</td>
<td width="50" align="center" class="td">排序</td>
<td width="68" align="center" class="td">操作</td>
</tr><%Dim rs,t,i
Set rs=Easp.db.GR("V_Zw:id,zw,bm","bmid="&id,"pxa desc")
if Easp.isN(rs) then
Easp.W "<tr><td colspan=""4"" class=""td"">暂无职位！</td></tr>"
else
t=rs.GetRows()
Easp.db.C(rs)	

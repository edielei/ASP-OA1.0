...
id=Easp.Get("id:n:0")
rs=Easp.db.RT("Users","id="&id,"zcgh,zname")
%><!DOCTYPE html>
<html lang="cn">
<head>
...
$(function(){
	...
	s.click(function(){
		...
		$.post('AddDangAnC.asp','gh='+gh+'&rzsj='+rzsj+'&zwid='+zwid+'&fj='+fj+'&zname='+zname+'&ozname='+ozname+'&xb='+xb+'&csrq='+csrq+'&mz='+mz+'&jg='+jg+'&zzmm='+zzmm+'&rtsj='+rtsj+'&hf='+hf+'&xl='+xl+'&xw='+xw+'&xz='+xz+'&sfzhm='+sfzhm+'&jk='+jk+'&grzp='+grzp+'&add='+add+'&jtdh='+jtdh+'&shouji='+shouji+'&xxjl='+xxjl+'&gzjy='+gzjy+'&hjqk='+hjqk+'&zycy='+zycy+'&jjlxr='+jjlxr+'&lxdh='+lxdh,function(a){
			switch(a){
				case 'OK':alert('添加档案成功！');location.replace('UserList.asp');break;
...
<table border="0" cellpadding="0" cellspacing="0" class="table">
	<tr><th class="th" colspan="6">&nbsp;填写用户档案</th></tr>
    <tr>
    	<td width="65" align="right" nowrap="nowrap" class="td">工号:</td><td class="td"><input id="gh" class="input" style="width:68px;" value="<%=rs(0)%>" /> <em title="必填项">*</em></td>
...
<td align="right" nowrap="nowrap" class="td">职位:</td><td class="td"><select class="input" id="zwid"><option value="">请选择</option></select> <em title="必填项">*</em></td>
   ...
   <tr>
   	...
   	<td class="td"><input id="zname" class="input" style="width:60px;" value="<%=rs(1)%>" /> <em title="必填项">*</em></td>
   ...
   <tr>
     <td width="65" align="right" nowrap="nowrap" class="td">家庭&nbsp;&nbsp;&nbsp;&nbsp;<br />
     主要成员:</td>

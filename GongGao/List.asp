...
<body>
<div id="sousuo"><form action="Search.asp" method="get">标题：<input id="bt" name="bt" style="width:150px;" /> 或 时间：<input id="sj" name="sj" class="srk" style="width:70px;" onfocus="WdatePicker()" />&nbsp;<input id="tj" type="submit" value="搜索" class="btnss" /></form></div>
<table border="0" cellpadding="0" cellspacing="0" class="table">
  <tr><th class="th" colspan="2"><img src="../Images/AM_gg.gif" alt="" /><a href="List.asp">公司公告</a></th></tr>
  <%Dim rs,t,i,rsa,n,ys,jc
Set rs=Easp.db.GPR("0:15",Array("Gg:id,bt,jc,ys,sj","xs=True","px desc"))
if Easp.isN(rs) then
Easp.W "<tr><td class=""td"" colspan=""2"" align=""center"">暂无公司公告！</td></tr></table>"
else

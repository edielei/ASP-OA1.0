...
id=Easp.Get("id:n:0")
r=db.RT("Wc","id="&id,"uname,kssj,jssj,nr")
%><!DOCTYPE html>
<html lang="cn">
<head>
...
$(function(){
	...
	s.click(function(){
		...
		$.post('EditWcC.asp','id=<%=id%>&kssj='+encodeURIComponent(kssj.val())+'&jssj='+encodeURIComponent(jssj.val())+'&nr='+nr,function(a){
			switch(a){
...
<tr>
	<th class="th" colspan="2">&nbsp;修改外出登记</th>
</tr>
	<tr>
	...
	<tr><td width="68" align="right" nowrap="nowrap" class="td">外出原因：</td><td class="td"><textarea id="nr" class="input" style="width:100%;height:130px;"><%=r(3)%></textarea></td></tr>

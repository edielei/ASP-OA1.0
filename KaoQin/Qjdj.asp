...
$(function(){
	...
	s.click(function(){
		...
		$.post('QjdjC.asp','kssj='+encodeURIComponent(kssj.val())+'&jssj='+encodeURIComponent(jssj.val())+'&nr='+nr,function(a){
			switch(a){
				...
				art.dialog.through({
					...
					time:3,
					close:function(){
						window.parent['mkj'].location='/KaoQin/SeeQj.asp';
						art.dialog.close();
					}
				});
				break;
...
<table>
	...
	<tr><td nowrap="nowrap">请假原因：</td><td><textarea id="nr" class="input"></textarea></td></tr>

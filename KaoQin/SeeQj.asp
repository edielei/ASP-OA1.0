...
<table border="0" cellpadding="0" cellspacing="0" class="table">
	<tr>
		<th class="th" colspan="2">&nbsp;请假登记</th>
	</tr>
<tr style="font-weight:700;background:#E9FAEF;">
    	<td class="td">&nbsp;请假原因</td>
    	<td width="140" class="td">请假时间</td>
    </tr>
    <%
	Dim rs,t,i
	Set rs=db.GPR("0:10",Array("Qj:id,nr,kssj,jssj","uname='"&Easp.Cookie("uinfo>uname")&"'","id desc"))
	if Easp.IsN(rs) then
	...
	%>
    <tr><td class="td">&nbsp;<a href="SeeQjx.asp?id=<%=t(0,i)%>"><%Easp.WH Easp.CutStr(t(1,i),"76:...")%></a></td><td width="140" class="td">开始：<%=Easp.DateTime(t(2,i),"yyyy-mm-dd hh:ii")%><br />结束：<%=Easp.DateTime(t(3,i),"yyyy-mm-dd hh:ii")%></td></tr>
    <%Next%>
</table>

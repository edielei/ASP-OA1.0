...
<body>
<div id="sousuo">时间：<input id="sj" name="sj" class="srk" style="width:70px;" onfocus="WdatePicker()" />&nbsp;<input id="tj" type="submit" value="搜索" class="btnss" /></div>
...
<tr>
	...
	Set rs=Easp.db.GPR("0:15",Array("Yj:id,bt,uname,sj","dx="&dx,"id desc"))
	if Easp.IsN(rs) then
	Easp.W "<tr><td colspan=""5"" align=""center"" class=""td"">暂无意见信息！</td></tr>"
	Else

...
<table border="0" cellpadding="0" cellspacing="0" class="table">
	<tr><th class="th" colspan="7">&nbsp;<a href="TzGl.asp">帖子管理</a></th></tr>
    ...
    <%
	Dim rs,t,i
	Set rs=db.GPR("0:15",Array("MyTz:id,bt,bk,sj,hfcs,cs,bkid,uname","","id desc"))
	if Easp.IsN(rs) then
	...
	%>
    <tr>
   	  <td nowrap="nowrap" class="td"><a href="TzShow.asp?id=<%=t(0,i)%>"><%Easp.WH Easp.CutStr(t(1,i),"22:...")%></a></td>

...
<body>
<div id="sousuo"><form action="<%Easp.W Easp.IIF(Easp.Cookie("uinfo>iszy"),"GlglS","Gls")%>.asp" method="get">标题：<input id="bt" name="bt" class="input" style="width:130px;" />&nbsp;或&nbsp;时间：<input id="sj" name="sj" class="srk" style="width:80px;" onfocus="WdatePicker()" /> <input id="tj" type="submit" class="btn" value="搜索" /></form></div>
<table border="0" cellpadding="0" cellspacing="0" class="table">
<tr>
    <th class="th" colspan="6">&nbsp;<a href="Gl.asp">管理资源文件</a></th>
</tr>
...
Set rs=Easp.db.GPR("0:15",Array("Zy:files,bt,sj,uname,ms,id","","id desc"))
Else
Set rs=Easp.db.GPR("0:15",Array("Zy:files,bt,sj,uname,ms,id","uname='"&Easp.Cookie("uinfo>uname")&"'","id desc"))
End If
if Easp.IsN(rs) then
Easp.W "<tr><td class=""td"" colspan=""6"" align=""center"">暂无资源文件！</td></tr></table>"
Else

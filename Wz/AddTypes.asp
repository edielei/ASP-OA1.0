...
$(function(){
	...
	s.click(function(){
		...
		$.post('AddTypesC.asp','types='+bt,function(a){
			switch(a){
				case 'OK':art.dialog.open.api.hide();art.dialog.through({icon:'succeed',content:'添加成功！',resize:false,ok:function(){art.dialog.open.origin.location='/Wz/Types.asp'},close:function(){art.dialog.open.origin.location='/Wz/Types.asp'}});break;

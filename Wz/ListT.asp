<!--#include file="../Inc/WzCs.asp"--><%Dim id
id=Easp.Get("id:n")
if Easp.IsN(id) then Easp.RR "List.asp"
%><!DOCTYPE html>
<html lang="cn">
<head>
...
<%
Dim rs,t,i
Set rs=db.GPR("0:15",Array("V_Wz:id,bt,ms,types,typesid,wz","uname='"&Easp.Cookie("uinfo>uname:s")&"' and typesid="&id,"px desc"))
if Easp.IsN(rs) then

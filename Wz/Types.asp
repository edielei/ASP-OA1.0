...
function addnew(){
	art.dialog.open('Wz/AddTypes.asp',{
		id:'addgzjhtypes',
		title:'新建类别',
		lock:true,
		duration:0,
...
function edit(num){
	art.dialog.open('Wz/EditTypes.asp?id='+num,{
		id:'editgzjhtypes',
		title:'修改类别',
		lock:true,
		duration:0,
...
<table border="0" cellpadding="0" cellspacing="0" class="table">
	<tr>
		<th class="th" colspan="2">&nbsp;<a href="Types.asp">网址类别管理</a></th>
	</tr>
    ...
    <%Dim rs,t,i
	Set rs=db.GPR("0:15",Array("Types:id,types","uname='"&Easp.Cookie("uinfo>uname:s")&"'","px desc"))
	if Easp.IsN(rs) then
